                                                    ...
                                                    <div class="subelementosSeccionPrincipal">
                                                        <div class="elementosSeccionPrincipalDS">
                                                            <div>
                                                                ...
                                                                <label id="lblCCC" runat="server" for="txtIban" class="lblEtiquetasPadd3">CCC</label>
                            ...
                            <div id="muestraGrupoPruebasExternas" class="elementoFila99Por mostrarControl" style="margin: 0px 0px 0px 0px;">
                                <rfn:RFNPanel ID="grupoPruebasExternas" runat="server" EstiloContenedor="False" Titulo="VSI"
                                    ...
                                    <div id="totalPruebas" class="control_derecha" style="margin: 20px 20px 20px 0px; display: none;">
                                        <div class="elementoColumna">
                                            <label id="lblRecosVSI" runat="server" class="lblEtiquetas" style="width: 75px; pointer-events: none; opacity: 0.6; display: none;">Reconocimientos</label>
                                        </div>
                                        <div class="elementoColumna">
                                                ...
                                                <div class="elementosSeccionPrincipalPadd5">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label id="lblImporteARTarifa" runat="server" class="control_txt" style="width: 70px; pointer-events: none; opacity: 0.6">Alto Riesgo:</label>
                                                            </td>
                                                            <td>&nbsp
                                                            </td>
                                                            <td>
                                                ...
                                                <fieldset id="fsDatosAnexoRenovacion" class="elementoFila99Por" style="margin: 0px 20px 20px 10px; width: 96%;">
                                                    ...
                                                    <div class="elementoColumna">
                                                        ...
                                                        <fieldset id="fsModalidadesContrato" class="seccionesPrincipales_prueba" style="width: 94%;">
                                                            <legend>
                                                                <label id="lblModSheCtrt" runat="server" for="txtModSheCtrt" class="lblEtiquetasPadd" style="pointer-events: none; opacity: 0.6; border-collapse: collapse">SHE</label>
                                                            </legend>
                                                            <table style="border-collapse: collapse;">
                                                                <tr style="border-collapse: collapse;">
                                                                    <%--Cheks--%>
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td style="border-collapse: collapse">
                                                                        <label id="lblRPFCtrato" runat="server" class="seccionesPrincipales_prueba" style="width: 70px; pointer-events: none; opacity: 0.6; width: 92%;">Reconocimientos</label>
                                                        ...
                                                        <fieldset id="fsModalidadesAnexo" class="seccionesPrincipales_prueba" style="width: 94%;">
                                                            <legend>
                                                                <label id="lblModSTAnx" runat="server" for="txtModSTAnx" class="lblEtiquetasPadd" style="border-collapse: collapse">ST</label>
                                                            </legend>
                                                            <table style="border-collapse: collapse;">
                                                                <tr style="border-collapse: collapse;">
                                                                    <td style="border-collapse: collapse">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td style="border-collapse: collapse">
                                                                        <label id="lblRPFAnexo" runat="server" class="seccionesPrincipales_prueba" style="width: 70px; pointer-events: none; opacity: 0.6; width: 92%;">Reconocimientos</label>
                                                                    </td>
                                                                    <td>&nbsp;
                                                                    </td>
                                                                    <td style="border-collapse: collapse">
                                    ...
                                    <div class="subelementosSeccionPrincipalPadd2">
                                        <div class="subelementosSeccionPrincipalPadd">
                                            <div id="contenedorCtrFecBaja" runat="server" class="elementosSeccionPrincipal">
                                                <label id="lblCtrContratoAntiguo" runat="server" for="txtCtrContratoAntiguo" class="lblEtiquetas" style="width: 75px; pointer-events: none; opacity: 0.6: True">Contrato Antiguo</label>
                                        ...
                                        <div class="subelementosSeccionPrincipalPadd2">
                                            <div class="subelementosSeccionPrincipalPadd">
                                                <div id="contenedorCtrFecBaja2" runat="server" class="elementosSeccionPrincipal">
                                                    <label id="lblCtrCausaBaja2" runat="server" for="ddlCtrCausaBaja2" class="lblEtiquetas" style="width: 75px; pointer-events: none; opacity: 0.6: True">Causa de baja</label>
